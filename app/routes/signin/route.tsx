...
import {requestCode, signIn} from "~/.server/db-bridge/auth.bridge";
...
export async function action({request}: Route.ActionArgs) {
    ...
    const {matricNumber , password} = Object.fromEntries(await request.formData()) as Record<string, string>

    const [success, data] = await safeTry(signIn(matricNumber , password))
